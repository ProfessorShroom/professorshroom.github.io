...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/car/250_sunvisor_1.jpg" title="Renault Megane MK3 Sunvisor Plug" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    The pins on the sunvisor that indicate if this supports the sunvisor light, if these are missing you need to replace the sunvisor.
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/car/250_sunvisor_2.jpg" title="Renault Megane MK3 Sunvisor Light" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/car/250_sunvisor_3.jpg" title="Renault Megane MK3 Sunvisor Light Loom" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
<div class="caption">
    Finished installation of the new sunvisor lights.
</div>
