...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/installer/installer_old.png" title="NorthPoint Automatic Software Installer GUI" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
